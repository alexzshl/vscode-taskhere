...
[![version](https://img.shields.io/vscode-marketplace/v/alexzshl.tasks-here.svg?style=flat-square&label=vscode%20marketplace)](https://marketplace.visualstudio.com/items?itemName=alexzshl.tasks-here)
[![installs](https://img.shields.io/vscode-marketplace/d/alexzshl.tasks-here.svg?style=flat-square)](https://marketplace.visualstudio.com/items?itemName=alexzshl.tasks-here)

Version 3.0.0 starts to use the new configuration form, the previous users please try to migrate.
